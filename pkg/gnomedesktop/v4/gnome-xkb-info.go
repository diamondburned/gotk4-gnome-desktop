...
// extern void _gotk4_gnomedesktop4_XkbInfo_ConnectLayoutsChanged(gpointer, guintptr);
import "C"
...
func (self *XkbInfo) ConnectLayoutsChanged(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(self, "layouts-changed", false, unsafe.Pointer(C._gotk4_gnomedesktop4_XkbInfo_ConnectLayoutsChanged), f)
}
