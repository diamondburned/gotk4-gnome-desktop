...
import (
	...
	"github.com/diamondburned/gotk4-gnome-desktop/pkg/gnomedesktop/v4"
...
// extern void _gotk4_gnomebg4_BG_ConnectTransitioned(gpointer, guintptr);
// extern void _gotk4_gnomebg4_BG_ConnectChanged(gpointer, guintptr);
import "C"
...
func (bg *BG) ConnectChanged(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(bg, "changed", false, unsafe.Pointer(C._gotk4_gnomebg4_BG_ConnectChanged), f)
}

func (bg *BG) ConnectTransitioned(f func()) coreglib.SignalHandle {
	return coreglib.ConnectGeneratedClosure(bg, "transitioned", false, unsafe.Pointer(C._gotk4_gnomebg4_BG_ConnectTransitioned), f)
}
...
func (bg *BG) CreateFrameThumbnail(factory *gnomedesktop.DesktopThumbnailFactory, screenArea *cairo.RectangleInt, destWidth, destHeight, frameNum int) *gdkpixbuf.Pixbuf {
	...
	var _arg2 *C.cairo_rectangle_int_t        // out
	var _arg3 C.int                           // out
	var _arg4 C.int                           // out
	var _arg5 C.int                           // out
	...
	_arg2 = (*C.cairo_rectangle_int_t)(gextras.StructNative(unsafe.Pointer(screenArea)))
...
func (bg *BG) CreateSurface(window gdk.Surfacer, width, height int) *cairo.Surface {
	...
	_arg0 = (*C.GnomeBG)(unsafe.Pointer(coreglib.InternObject(bg).Native()))
	_arg1 = (*C.GdkSurface)(unsafe.Pointer(coreglib.InternObject(window).Native()))
	_arg2 = C.int(width)
	_arg3 = C.int(height)
